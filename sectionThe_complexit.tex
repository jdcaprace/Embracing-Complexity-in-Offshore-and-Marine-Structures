...
The model is given in equation \ref{eqn:EqAgregComp}, %where $C_T$ represents the total complexity or aggregated complexity and $w1, \cdots , wi$ represents numerical constants called weighting factors.
