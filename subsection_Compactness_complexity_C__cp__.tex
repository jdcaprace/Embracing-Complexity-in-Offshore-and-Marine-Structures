...
For 3D shapes, the most usual shape complexity measure is the sphericity (see equation \ref{eqn:EqShapeComplexity3D}), is the ratio of the lateral surface of a sphere (with the same volume as the given solid) to the surface area of a 3D solid, defined by \cite{wadell1935volume}. %******RETIRADO*****
